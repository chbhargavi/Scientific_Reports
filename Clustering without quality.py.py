...
cluster_requesters = {}
cluster_ids = list(cluster_executors.keys())
...
for cluster_id, winners in cluster_executors.items():
    # =====================================================
    ...
    final_executors = cluster_executors[cluster_id]   # without QTESM
...
print(f"2. Clustering Running Time : "
      f"{clustering_running_time:.3f} ms")
...
print(f"8. Overall McAfee Running Time "
      f"(Clustering + McAfee) : "
      f"{(clustering_running_time + overall_mcafee_time):.3f} ms")

print(f"9. Overall MUDA Running Time "
      f"(Clustering + MUDA) : "
      f"{(clustering_running_time + overall_muda_time):.3f} ms")

print(f"10. Overall TMUDA Running Time "
      f"(Clustering + TMUDA) : "
      f"{(clustering_running_time + overall_tmuda_time):.3f} ms")

print(f"11. Overall PPM Running Time "
      f"(Clustering + PPM) : "
      f"{(clustering_running_time + overall_ppm_time):.3f} ms")

print("\n=========== EXECUTOR RESULTS WITHOUT QUALITY (QTESM) ===========")

print("McAfee Requester Utility Without Quality :",
      overall_mcafee_req_util)

print("McAfee Executor Utility Without Quality :",
      overall_mcafee_exe_util)

print("McAfee Payment to Executors Without Quality :",
      overall_mcafee_exe_payment)

print("MUDA Requester Utility Without Quality :",
      overall_muda_req_util)

print("MUDA Executor Utility Without Quality :",
      overall_muda_exe_util)

print("MUDA Payment to Executors Without Quality :",
      overall_muda_exe_payment)


print("TMUDA Executor Utility Without Quality :",
      overall_tmuda_exe_util)
print("TMUDA Requester Utility Without Quality :",
      overall_tmuda_req_util)

print("TMUDA Payment to Executors Without Quality :",
      overall_tmuda_exe_payment)

print("PPM Executor Utility Without Quality :",
      overall_ppm_exe_util)
print("PPM Requester Utility Without Quality :",
      overall_ppm_req_util)
         
print("PPM Payment to Executors Without Quality :",
      overall_ppm_exe_payment)