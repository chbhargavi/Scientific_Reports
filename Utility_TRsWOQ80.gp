...
set output "Utility_TRsWOQ80.png"
...
plot "Utility_TRsWOQ80.txt" using 2:xtic(1) title "McAfee" lc rgb "#2471A3", \
     "Utility_TRsWOQ80.txt" using 3 title "MUDA" lc rgb "#E32636", \
     "Utility_TRsWOQ80.txt" using 4 title "TRUST-SC" lc rgb "#006400",\
     "Utility_TRsWOQ80.txt" using 5 title "PPM" lc rgb "#0xc04000",\
