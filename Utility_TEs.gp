...
plot "Utility_TEs.txt" using 2:xtic(1) title "McAfee" lc rgb "#2471A3", \
     "Utility_TEs.txt" using 3 title "MUDA" lc rgb "#E32636", \
     "Utility_TEs.txt" using 4 title "TRUST-SC" lc rgb "#006400",\
       "Utility_TEs.txt" using 5 title "PPM" lc rgb "#0xc04000",\
          #"Utility_TEs.txt" using 6 title "PPM-D" lc rgb "#c8c800",\
